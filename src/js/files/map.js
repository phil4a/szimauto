...
function map(n) {
	...
	function init() {
		...
		var myMap = new ymaps.Map('map', {
			...
			center: [54.979173, 82.907665],
			// Уровень масштабирования. Допустимые значения:
			// от 0 (весь мир) до 19.
			zoom: 16,
		});
		let szimBaloonLayout = ymaps.templateLayoutFactory.createClass(`
			<div class="baloon">
				<h2>Автоодеяла СЗИМ</h2>
				<p><b>Адрес: </b>г. Новосибирск, ул. Ватутина, 71</p>
				<p><b>Тел: </b>+7(983)510-48-50</p>
				<p><b>Email: </b>szim2019@gmail.com</p>
			</div>
			`);
		let myPlacemark = new ymaps.Placemark(
			...
			{},
			{
				...
				balloonContentLayout: szimBaloonLayout,
				hasBalloon: true,
